...
void TestRandom()
{
    std::cout << "测试 Randomsize" << std::endl;
    ...
    std::cout << "测试 Randomuint32" << std::endl;
    for (size_t i = 0; i < 10; i++)
    {
    ...
    std::cout << "测试 Randomint32" << std::endl;
    for (size_t i = 0; i < 10; i++)
    {
    ...
    std::cout << "测试 Randomuint64" << std::endl;
    for (size_t i = 0; i < 10; i++)
    {
    ...
    std::cout << "测试 Randomint64" << std::endl;
    for (size_t i = 0; i < 10; i++)
    {
    ...
    std::cout << "测试 Randombool" << std::endl;
    ...
    std::cout << "测试 Randomfloat" << std::endl;
    for (size_t i = 0; i < 10; i++)
    {
    ...
    std::cout << "测试 Randomdouble" << std::endl;
    for (size_t i = 0; i < 10; i++)
    {
    ...
    std::cout << "测试 Randomstring" << std::endl;
    for (size_t i = 0; i < 10; i++)
    {
    ...
    std::cout << "测试 Randombytes" << std::endl;
    for (size_t i = 0; i < 10; i++)
    {
    ...
    std::cout << "测试 GetRandomByteCount" << std::endl;
    for (size_t i = 0; i < 10; i++)
    {
