...
namespace ItemFlowEnum{
    ...
    enum class Reason: uint32_t {
        ...
        ITEM_REASON_COLLECT_GARDEN = 54,
        ITEM_REASON_COLLECT_MINING = 55,
        ITEM_REASON_COLLECT_FOOD = 56,
        ITEM_REASON_COLLECT_MEDICINE = 57,
        ITEM_REASON_COLLECT_DESSERT = 58,
        ITEM_REASON_COLLECT_SMELT = 59,
        ITEM_REASON_COLLECT_FISHING = 60,
        ITEM_REASON_ENDLESS_TOWER = 61,
        ITEM_REASON_BATTLEGROUND = 62,
        ITEM_REASON_TRIAL = 63,
        ITEM_REASON_TRAIN_ELITE = 64,
        ITEM_REASON_TRAIN_TREASURE = 65,
        ITEM_REASON_MINI = 66    };    
    ...
    enum class iGoodsType: uint32_t {
        ...
        ITEM_FASHION = 600,
        ITEM_MATERIAL = 300    };    
    enum class SubGoodsType: uint32_t {
        RECOVERY = 201,
        STATUS = 202,
        FUNCTION = 206,
        CHEST = 209,
        ...
        LIFT_TOOL = 311,
        HEADWEAR_DRA = 312,
        HEADWEAR_DRA_HIGH = 313,
        HEADWEAR_DRA_LOW = 314    };    
...
namespace SceneUIFlowEnum{
    ...
    enum class UIType: uint32_t {
        ...
        LADDER = 1,
        KETTLE = 2    };    
    enum class ActType: uint32_t {
        DEFAULT = 0,
        BREAK = 1,
        OPEN = 2,
        TREAD = 3    };    
    enum class PrizeType: uint32_t {
        ITEM = 0,
        BUFF = 1,
        ACTION = 2,
        TASKSWITCH = 3,
...
namespace MallTradeFlowEnum{
    ...
    enum class Gender: uint32_t {
        MAN = 0,
        WOMAN = 1    };    
    enum class MallType: uint32_t {
        GOLDEN = 0,
        WANSHIWU = 1,
        SHENMI = 2    };    
    enum class MallSubType: uint32_t {
        GOLDEN_HOT = 10,
        GOLDEN_PACKAGE = 11,
        WANSHIWU_ZENY = 20,
        WANSHIWU_COIN = 21    };    
...
namespace RoleDeleteFlowEnum{
    ...
    enum class vopenid: uint32_t {
        IOS = 0,
        ANDROID = 1    };    
    enum class iJobLevel: uint32_t {
        NORMAL = 0,
        KICKOUT = 1    };    
...
namespace EquipFlowEnum{
    ...
    enum class OperateType: uint32_t {
        ...
        GET_BACK = 2,
        GET_SUIT = 3,
        GET_MULTI_TELENT_WAAR = 4,
        GET_MULTI_TELENT_TAKE = 5    };    
}
...
class EdenTaskFlow : public RoleCommonTlogBase
{
public:
    virtual void DoAdd() override
    {
        ...
        AddLog("LoginChannel", ToStringTlog(LoginChannel)); 
        AddLog("OperateType", ToStringTlog(OperateType)); 
        AddLog("EdenTaskID", ToStringTlog(EdenTaskID)); 
        AddLog("EdenTaskName", EdenTaskName); 
        AddLog("EdenSpecialNum", ToStringTlog(EdenSpecialNum)); 
        AddLog("EdenSpecialFinishNum", ToStringTlog(EdenSpecialFinishNum)); 
        AddLog("EdenLuckyAwardNum", ToStringTlog(EdenLuckyAwardNum)); 
        AddLog("EdenSpecialAwardNum", ToStringTlog(EdenSpecialAwardNum)); 
        AddLog("EdenMoneyCost", ToStringTlog(EdenMoneyCost)); 
        AddLog("MoneyType", ToStringTlog(MoneyType)); 
    ...
    virtual void DoAddJson() override
    {
        ...
        AddLogJson("\"LoginChannel\":"+ ToStringTlog(LoginChannel)); 
        AddLogJson("\"OperateType\":"+ ToStringTlog(OperateType)); 
        AddLogJson("\"EdenTaskID\":"+ ToStringTlog(EdenTaskID)); 
        AddLogJson("\"EdenTaskName\":\""+EdenTaskName+"\""); 
        AddLogJson("\"EdenSpecialNum\":"+ ToStringTlog(EdenSpecialNum)); 
        AddLogJson("\"EdenSpecialFinishNum\":"+ ToStringTlog(EdenSpecialFinishNum)); 
        AddLogJson("\"EdenLuckyAwardNum\":"+ ToStringTlog(EdenLuckyAwardNum)); 
        AddLogJson("\"EdenSpecialAwardNum\":"+ ToStringTlog(EdenSpecialAwardNum)); 
        AddLogJson("\"EdenMoneyCost\":"+ ToStringTlog(EdenMoneyCost)); 
        AddLogJson("\"MoneyType\":"+ ToStringTlog(MoneyType)); 
...
public:
    int32_t OperateType {0};
    int32_t EdenTaskID {0};
    std::string EdenTaskName {""};
    int32_t EdenSpecialNum {0};
    int32_t EdenSpecialFinishNum {0};
    int32_t EdenLuckyAwardNum {0};
    int32_t EdenSpecialAwardNum {0};
    int32_t EdenMoneyCost {0};
    int32_t MoneyType {0};
...
public:
    virtual void DoAdd() override
    {
        ...
        AddLog("UnionJudge", ToStringTlog(UnionJudge)); 
        AddLog("FriendPoints", ToStringTlog(FriendPoints)); 
        AddLog("TreasureUniqueId", ToStringTlog(TreasureUniqueId)); 
        AddLog("TreasureHelpTimes", ToStringTlog(TreasureHelpTimes)); 
    ...
    virtual void DoAddJson() override
    {
        ...
        AddLogJson("\"UnionJudge\":"+ ToStringTlog(UnionJudge)); 
        AddLogJson("\"FriendPoints\":"+ ToStringTlog(FriendPoints)); 
        AddLogJson("\"TreasureUniqueId\":"+ ToStringTlog(TreasureUniqueId)); 
        AddLogJson("\"TreasureHelpTimes\":"+ ToStringTlog(TreasureHelpTimes)); 
...
public:
    ...
    int32_t UnionJudge {0};
    int32_t FriendPoints {0};
    int32_t TreasureUniqueId {0};
    int32_t TreasureHelpTimes {0};
...
namespace TaskFlowEnum{
    ...
    enum class TaskType: uint32_t {
        KTASKTYPENONE = 0,
        KTASKTYPEMAINSTORY = 1,
        KTASKTYPEBRANCH = 2,
        KTASKTYPEPROFESSION = 3,
        KTASKTYPEDAILY = 4,
        KTASKTYPEWEEKLY = 5,
        KTASKTYPEGUIDE = 6,
        KTASKTYPESURPRISE = 7,
        ...
        KTASKTYPEEDEN = 9,
        KTASKTYPEAISHEN = 10,
        KTASKTYPEEDENURGENT = 11,
        KTASKTYPEADVENTURE = 12,
        KTASKTYPEDUNGEON = 13,
        KTASKTYPELIFE = 14,
        KTASKTYPEWORLDPVE = 15    };    
}
