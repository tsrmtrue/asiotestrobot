...
ROOT_PATH = '../../../config/Table/Tools/Tlog/'

files = [fd for fd in os.listdir(ROOT_PATH) if os.path.isfile(os.path.join(ROOT_PATH, fd)) and  fd.endswith('.xlsx')]
...
"""
workbook = xlrd.open_workbook(os.path.join(ROOT_PATH, target_file))
