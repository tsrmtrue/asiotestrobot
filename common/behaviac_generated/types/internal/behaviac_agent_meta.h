...
namespace behaviac
{
	...
	inline void Set_FirstAgent_localCanshu(Agent* self, int value) { ((FirstAgent*)self)->_Get_Property_<PROPERTY_TYPE_FirstAgent_localCanshu, int >() = value; };
	inline const void* Get_FirstAgent_localCanshu(Agent* self) { return &((FirstAgent*)self)->_Get_Property_<PROPERTY_TYPE_FirstAgent_localCanshu, int >(); };
