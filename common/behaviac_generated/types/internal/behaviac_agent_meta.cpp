...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			...
			// FirstAgent
			meta = BEHAVIAC_NEW AgentMeta(2927492815u);
			AgentMeta::GetAgentMetas()[1778122110u] = meta;
			meta->RegisterMemberProperty(4132396641u, BEHAVIAC_NEW CMemberProperty< int >("localCanshu", Set_FirstAgent_localCanshu, Get_FirstAgent_localCanshu));
