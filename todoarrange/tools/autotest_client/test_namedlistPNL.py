...
SStageInfo = namedList("SStageInfo", "stageId,md5[33],name[64],desc[256],size,")
SStageFile = namedList("SStageFile", "stageId,blockId,nextBlcokId,length,file[30720],")
...
SMiscDB = namedList("SMiscDB", "shootMonsterCount,level,vigor,exp,")
