...
def buildAll():
    parseFile('../../Bin/Server/cfg/buff_utf8.csv', 'BuffConfig')
    parseFile('../../Bin/Server/cfg/fuben_utf8.csv', 'FubenConfig')
    parseFile('../../Bin/Server/cfg/guaiwushuxing_utf8.csv', 'MonsterConfig')
    parseFile('../../Bin/Server/cfg/guaiwuzhenrong_utf8.csv', 'MonsterArrayConfig')
    parseFile('../../Bin/Server/cfg/huobanshuxing_utf8.csv', 'MateConfig')
    parseFile('../../Bin/Server/cfg/jineng_utf8.csv', 'SkillConfig')
    parseFile('../../Bin/Server/cfg/jingyan_utf8.csv', 'ExpConfig')
    parseFile('../../Bin/Server/cfg/wupin_utf8.csv', 'ItemConfig')
    #parseFile('../../Bin/Server/cfg/xingjijiacheng_utf8.csv', 'StarLevelConfig')
    parseFile('../../Bin/Server/cfg/zhenxing_utf8.csv', 'ArrayConfig')
    parseFile('../../Bin/Server/cfg/zhiye_utf8.csv', 'ProfessionConfig')
    parseFile('../../Bin/Server/cfg/npc_utf8.csv', 'NpcConfig')
    parseFile('../../Bin/Server/cfg/renwu_utf8.csv', 'RenwuConfig')
    parseFile('../../Bin/Server/cfg/qianghuaxiaohao_utf8.csv', 'StrengthenConfig')
    parseFile('../../Bin/Server/cfg/hecheng_utf8.csv', 'CompoundConfig')
    parseFile('../../Bin/Server/cfg/zhuangbei_utf8.csv', 'EquipmentConfig')
    parseFile('../../Bin/Server/cfg/libao_utf8.csv', 'GiftConfig')
    parseFile('../../Bin/Server/cfg/huobanshengwangzhaomu_utf8.csv', 'RecruitPopularityConfig')
    parseFile('../../Bin/Server/cfg/huobansuijizhaomu_utf8.csv', 'RecruitRandomConfig')
    parseFile('../../Bin/Server/cfg/huobanpinzhijiacheng_utf8.csv', 'MateQualityConfig')
    
    writeStructHFile('../../Common/Configure/ConfigureStruct.h')
    writeHFile('../../Common/Configure/ConfigureParser.h')
    writeCppFile('../../Common/Configure/ConfigureParser.cpp')
