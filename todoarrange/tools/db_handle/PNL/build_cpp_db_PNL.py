...
def main(sqlHelpHFile):
    str = ''
    str += parse_sql_base.build_sql_by_createsql(['account', 'role', 'rank', 'iap_transaction_id', "gang", "iapppay", "biogame_role", "log"])
    #-----------------------帐号数据
    #########mac 登陆
    #mac地址查询
    global g_sql_map
    ...
    #---------------------log
    str += parse_sql_base.build_insert_sql_by_field_list(['type', 'log', 'userId', 'userName'], 'log', "insert_log")
...
main('../../../Common/ProtocolsPNL/SqlOperationHlp_PNL.h')
