...
def alter_role_add_parameters(_host, _user, _passwd, _port, _dbname):
...
alter_role_add_parameters(server_cfg.db_ip, server_cfg.db_user, server_cfg.db_pwd, server_cfg.db_port, server_cfg.db_name) 
