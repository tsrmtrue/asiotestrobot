...
def parseHFile(filename):
    ...
    w = open('../Common/Protocols/protocolEncode4cpp.cpp', 'w')
    w.write(build_encode_4_cpp_cpp("protocolEncode4cpp.h"))
    w.close()
    
    w = open('../Common/Protocols/protocolEncode4cpp.h', 'w')
    w.write(build_encoding_4_cpp_h("protocols.h"))
    w.close()

    w = open('../Common/Protocols/protocolDecode4cpp.cpp', 'w')
    w.write(build_decode_4_cpp_cpp("protocolDecode4cpp.h"))
    w.close()
    
    w = open('../Common/Protocols/protocolDecode4cpp.h', 'w')
...
def parseHFilePassport(filename):
    global g_enum_dict 
    g_enum_dict = {}
    global g_decoding_function_decl
    g_decoding_function_decl = []
    ...
    w = open('../Common/ProtocolsS2S/protocolPassportEncode4cpp.cpp', 'w')
    w.write(build_encode_4_cpp_cpp("protocolPassportEncode4cpp.h"))
    w.close()
    
    w = open('../Common/ProtocolsS2S/protocolPassportEncode4cpp.h', 'w')
    w.write(build_encoding_4_cpp_h("protocolPassport.h"))
    w.close()

    w = open('../Common/ProtocolsS2S/protocolPassportDecode4cpp.cpp', 'w')
    w.write(build_decode_4_cpp_cpp("protocolPassportDecode4cpp.h"))
    w.close()
    
    w = open('../Common/ProtocolsS2S/protocolPassportDecode4cpp.h', 'w')
    w.write(build_decoding_4_cpp_h("protocolPassport.h"))
    w.close()
    print "OK"

def mainPassport():
    global g_modulePrefix
    g_modulePrefix = "_PASSPORT"
    parseHFilePassport("../Common/ProtocolsS2S/protocolPassport.h")
